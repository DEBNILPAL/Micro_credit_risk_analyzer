...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 transition-all duration-500 ${isNavigating ? 'opacity-75 scale-95' : 'opacity-100 scale-100'}`}>
          ...
          <div className="flex justify-between items-center h-16 sm:h-18">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                <div className="bg-gradient-to-br from-brand-500 to-brand-600 p-2 rounded-xl shadow-soft mr-2 sm:mr-3">
                  <Shield className="h-6 w-6 sm:h-8 sm:w-8 text-white" />
                </div>
                <span className="text-sm sm:text-xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent hidden sm:block">Micro Credit Risk Analyzer</span>
                <span className="text-sm font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent sm:hidden">MCRA</span>
              </div>
            </div>
            ...
            <div className="md:hidden flex items-center space-x-2">
              ...
              <button 
                onClick={handleGetStarted}
                disabled={isNavigating}
                className={`px-4 py-2 text-xs rounded-xl font-semibold transition-all duration-300 shadow-soft ${
                  isNavigating 
                    ? 'bg-slate-400 cursor-not-allowed' 
      ...
      {/* Hero Section */}
      <section className="pt-20 sm:pt-32 pb-12 sm:pb-20 bg-gradient-to-br from-brand-50/50 via-white to-primary-50/30 flex items-center min-h-[60vh] sm:min-h-[70vh] relative overflow-hidden">
        {/* Background decoration */}
        <div className="absolute inset-0">
          <div className="absolute top-10 sm:top-20 left-5 sm:left-10 w-48 h-48 sm:w-72 sm:h-72 bg-brand-200/20 rounded-full blur-3xl"></div>
          <div className="absolute bottom-10 sm:bottom-20 right-5 sm:right-10 w-64 h-64 sm:w-96 sm:h-96 bg-primary-200/20 rounded-full blur-3xl"></div>
        </div>
          ...
          <div className="text-center">
            ...
            <div className="mt-8 sm:mt-12">
              <button 
                onClick={handleGetStarted}
                disabled={isNavigating}
                className={`px-6 sm:px-10 py-3 sm:py-4 rounded-2xl text-base sm:text-lg font-bold transition-all duration-300 shadow-large ${
                  isNavigating 
                    ? 'bg-slate-400 cursor-not-allowed' 
              ...
              >
                {isNavigating ? (
                  <div className="flex items-center">
                    <Loader className="animate-spin h-4 w-4 sm:h-5 sm:w-5 mr-2 sm:mr-3" />
                    <span className="hidden sm:inline">Launching App...</span>
                    <span className="sm:hidden">Loading...</span>
                  </div>
                ) : (
                  <>
                    <span className="hidden sm:inline">Start Risk Analysis →</span>
      ...
      <section className="py-12 sm:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-4">Our Solution</h2>
            <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto px-4">
      ...
      <section id="features" className="py-12 sm:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-lg text-gray-600 px-4">Built for hackathons, ready for production</p>
          </div>
      ...
      {/* Call to Action */}
      <section className="py-12 sm:py-20 bg-gradient-to-r from-brand-600 via-brand-500 to-primary-600 text-white relative overflow-hidden">
        {/* Background decoration */}
        <div className="absolute inset-0">
          <div className="absolute top-5 sm:top-10 left-10 sm:left-20 w-48 h-48 sm:w-64 sm:h-64 bg-white/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-5 sm:bottom-10 right-10 sm:right-20 w-60 h-60 sm:w-80 sm:h-80 bg-white/5 rounded-full blur-3xl"></div>
        </div>
        
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 px-2">Ready to Transform Credit Assessment?</h2>
          <p className="text-base sm:text-xl md:text-2xl mb-8 sm:mb-12 opacity-90 max-w-3xl mx-auto leading-relaxed px-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 px-4">
            ...
            <button className="border-2 border-white/80 text-white px-6 sm:px-10 py-3 sm:py-4 rounded-2xl text-base sm:text-lg font-bold hover:bg-white/10 hover:border-white transition-all duration-300 backdrop-blur-sm">
