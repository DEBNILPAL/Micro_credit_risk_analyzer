...
const FileUpload: React.FC<FileUploadProps> = ({ onFileProcessed, isLoading, setIsLoading }) => {
  ...
  const calculateRiskScore = (userData: UserData[]): { scores: RiskScore[], stats: DashboardStats } => {
    const scores: RiskScore[] = userData.map(user => {
      // Use advanced ML-based credit scoring engine
      return MLCreditEngine.predictCreditScore(user);
    });
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-soft border border-slate-200 overflow-hidden">
        ...
        <div className="p-4 sm:p-6 space-y-4">
          <div className="bg-white rounded-xl border border-gray-200 p-3 sm:p-4">
            <div className="mb-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2">
                <div className="bg-blue-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-blue-200">
                  <span className="text-xs font-medium text-blue-700 break-words">user_id</span>
                </div>
                <div className="bg-green-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-green-200">
                  <span className="text-xs font-medium text-green-700 break-words">monthly_income</span>
                </div>
                <div className="bg-purple-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-purple-200">
                  <span className="text-xs font-medium text-purple-700 break-words">income_type</span>
                </div>
                <div className="bg-indigo-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-indigo-200">
                  <span className="text-xs font-medium text-indigo-700 break-words">income_stability_months</span>
                </div>
                <div className="bg-orange-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-orange-200">
                  <span className="text-xs font-medium text-orange-700 break-words">emergency_savings</span>
                </div>
                <div className="bg-pink-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-pink-200">
                  <span className="text-xs font-medium text-pink-700 break-words">electricity_bill_on_time</span>
                </div>
                <div className="bg-slate-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-slate-200">
                  <span className="text-xs font-medium text-slate-700 break-words">dth_recharge_on_time</span>
                </div>
                <div className="bg-gray-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-gray-200">
                  <span className="text-xs font-medium text-gray-700 break-words">internet_bill_on_time</span>
                </div>
                <div className="bg-red-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-red-200">
                  <span className="text-xs font-medium text-red-700 break-words">rent_payment_on_time</span>
                </div>
                <div className="bg-cyan-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-cyan-200">
                  <span className="text-xs font-medium text-cyan-700 break-words">existing_loan_emi</span>
                </div>
                <div className="bg-red-100 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-red-300">
                  <span className="text-xs font-medium text-red-800 break-words">previous_loan_defaults</span>
                </div>
                <div className="bg-yellow-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-yellow-200">
                  <span className="text-xs font-medium text-yellow-700 break-words">upi_transactions_per_month</span>
                </div>
                <div className="bg-emerald-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-emerald-200">
                  <span className="text-xs font-medium text-emerald-700 break-words">digital_wallet_usage</span>
                </div>
                <div className="bg-violet-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-violet-200">
                  <span className="text-xs font-medium text-violet-700 break-words">online_bill_payments</span>
                </div>
                <div className="bg-rose-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-rose-200">
                  <span className="text-xs font-medium text-rose-700 break-words">monthly_expenses</span>
                </div>
                <div className="bg-teal-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-teal-200">
                  <span className="text-xs font-medium text-teal-700 break-words">savings_rate</span>
                </div>
                <div className="bg-amber-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-amber-200">
                  <span className="text-xs font-medium text-amber-700 break-words">age</span>
                </div>
                <div className="bg-stone-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-stone-200">
                  <span className="text-xs font-medium text-stone-700 break-words">employment_type</span>
                </div>
                <div className="bg-lime-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-lime-200">
                  <span className="text-xs font-medium text-lime-700 break-words">years_of_employment</span>
                </div>
                <div className="bg-sky-50 px-2 sm:px-3 py-1 sm:py-2 rounded-lg border border-sky-200">
                  <span className="text-xs font-medium text-sky-700 break-words">city_tier</span>
                </div>
              </div>
            </div>
            
            <div className="border-t border-gray-200 pt-3">
              <h4 className="text-xs sm:text-sm font-semibold text-gray-700 mb-2">Sample Data:</h4>
              <div className="bg-gray-50 rounded-lg p-2 sm:p-3 overflow-x-auto">
                <div className="text-xs text-gray-500 mb-2 sm:hidden">Scroll horizontally to see more →</div>
                <div className="flex space-x-2 sm:space-x-3 text-xs min-w-max">
                  <div className="flex flex-col space-y-1">
                    <div className="font-semibold text-gray-500 bg-white px-2 py-1 rounded border">user_id</div>
                    <div className="font-medium text-gray-600 px-2 py-1">U001</div>
                    <div className="font-medium text-gray-600 px-2 py-1">U003</div>
                  </div>
                  <div className="flex flex-col space-y-1">
                    <div className="font-semibold text-gray-500 bg-white px-2 py-1 rounded border">income</div>
                    <div className="font-medium text-gray-600 px-2 py-1">53682</div>
                    <div className="font-medium text-gray-600 px-2 py-1">62611</div>
                  </div>
                  <div className="flex flex-col space-y-1">
                    <div className="font-semibold text-gray-500 bg-white px-2 py-1 rounded border">type</div>
                    <div className="font-medium text-gray-600 px-2 py-1">salary</div>
                    <div className="font-medium text-gray-600 px-2 py-1">freelance</div>
                  </div>
                  <div className="flex flex-col space-y-1">
                    <div className="font-semibold text-gray-500 bg-white px-2 py-1 rounded border">savings</div>
                    <div className="font-medium text-gray-600 px-2 py-1">178698</div>
                    <div className="font-medium text-gray-600 px-2 py-1">140890</div>
                  </div>
                  <div className="flex flex-col space-y-1">
                    <div className="font-semibold text-gray-500 bg-white px-2 py-1 rounded border">bills</div>
                    <div className="font-medium text-gray-600 px-2 py-1">79%</div>
                    <div className="font-medium text-gray-600 px-2 py-1">77%</div>
                  </div>
                  <div className="flex flex-col space-y-1">
                    <div className="font-semibold text-gray-500 bg-white px-2 py-1 rounded border">emi</div>
                    <div className="font-medium text-gray-600 px-2 py-1">10844</div>
                    <div className="font-medium text-gray-600 px-2 py-1">14809</div>
                  </div>
                  <div className="flex flex-col space-y-1">
                    <div className="font-semibold text-gray-500 bg-white px-2 py-1 rounded border">...</div>
                    <div className="font-medium text-gray-600 px-2 py-1">...</div>
                    <div className="font-medium text-gray-600 px-2 py-1">...</div>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-r from-brand-50 to-primary-50 rounded-xl p-3 sm:p-4 border border-brand-200">
            <div className="flex items-start space-x-2 sm:space-x-3">
              ...
              <div className="min-w-0 flex-1">
                <h4 className="font-bold text-brand-800 mb-2 text-sm sm:text-base">RBI Compliance Integration</h4>
                <p className="text-brand-700 text-xs sm:text-sm leading-relaxed">
                  Our risk scoring engine incorporates Reserve Bank of India guidelines including:
                </p>
                <ul className="text-brand-700 text-xs sm:text-sm mt-2 space-y-1">
