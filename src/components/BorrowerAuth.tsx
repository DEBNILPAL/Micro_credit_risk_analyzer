...
import { User, Lock, Mail, Phone, MapPin, Calendar, ArrowLeft } from 'lucide-react';
...
const BorrowerAuth: React.FC<BorrowerAuthProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      ...
      <button
        onClick={() => navigate('/')}
        className="absolute top-6 left-6 flex items-center px-4 py-2 bg-white/90 backdrop-blur-sm rounded-xl shadow-md border border-slate-200 text-slate-700 hover:bg-white hover:shadow-lg transition-all duration-200 group z-10"
      >
